...
TEMPLATE_FOLDER = "fonts/templates/" # characters extracted from input fonts
REAL_DATA_FOLDER = "fonts/real_chars/" # characters extracted from real license plate
CHAR_FOLDER  = "fonts/chars/" # used to containt augumented characters
